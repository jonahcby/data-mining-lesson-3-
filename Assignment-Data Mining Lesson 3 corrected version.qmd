---
title: "Probabilistic Learning with Naive Bayes Classification Corrected version"
format: html
editor: visual
---
...
#Errors report :
29&30 : there is # before head and view
44 : Text instead of text 
68&69 : one = instead of ==
136 & 137 : ) missing at the end 
Line 138 -> Removed argument ', "True"' from dnn = c("Prediction", "True")
...
```{r}
predVec <- predict(nbayesModel, testDTM)
confusionMatrix(predVec, testDF$label, positive = "Fake news", dnn = c("Prediction","True"))
```
